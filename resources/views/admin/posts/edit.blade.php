<x-app-layout>
    ...
    <div class="min-h-screen" style="background-color: #669bbc;">
        <main class="max-w-4xl mx-auto p-8">
            <div class="rounded-lg shadow-lg p-8" style="background-color: #1b263b;">
                <h1 class="text-2xl font-bold mb-6 text-white">Edit Post</h1>
                ...
                <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}"
                            required class="mt-1 block w-full border border-gray-400 rounded-md shadow-sm p-2 bg-gray-100 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="5" required
                            class="mt-1 block w-full border border-gray-400 rounded-md shadow-sm p-2 bg-gray-100 focus:ring-blue-500 focus:border-blue-500">{{ old('content', $post->content) }}</textarea>
                    </div>

                    <!-- Photo Upload with Live Preview -->
                    <div x-data="{ fileName: '', previewUrl: '' }">
                        <label class="block text-sm font-medium text-white mb-1">Upload Photo (optional)</label>
                    ...
                    <div>
                        <label for="photo_url" class="block text-sm font-medium text-white">Or Photo URL (optional)</label>
                        <input type="url" name="photo_url" id="photo_url" value=""
                            class="mt-1 block w-full border border-gray-400 rounded-md shadow-sm p-2 bg-gray-100 focus:ring-blue-500 focus:border-blue-500">
                    </div>

<x-app-layout>
    ...
    <div class="min-h-screen bg-cover bg-center flex items-center justify-center p-6"
        style="background-image: url('https://i.pinimg.com/1200x/1a/00/6d/1a006d8518a85234dc1d912439ba9916.jpg');">
        
        <div class="bg-white bg-opacity-80 backdrop-blur-md rounded-lg shadow-lg max-w-4xl w-full p-8 border border-gray-300">
